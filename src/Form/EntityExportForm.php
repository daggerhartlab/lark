...
class EntityExportForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($submitted_values as $uuid => $values) {
      ...
      foreach ($this->formPluginManager->getInstances() as $form_plugin) {
        ...
        $plugin_values = $form_plugin->processValues($values[$form_plugin->id()], $uuid, $form_state);
        if ($plugin_values) {
  ...
  private function exportableTableRows(ExportableInterface $exportable, array &$form, FormStateInterface $form_state, array $render_parents = []): array {
    ...
    foreach ($this->formPluginManager->getInstances() as $form_plugin) {
      $form_row['form']['data'][$form_plugin->id()] = $form_plugin->buildElement($exportable, $form, $form_state, $render_parents);
    }
